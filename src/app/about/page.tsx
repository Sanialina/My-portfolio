  ...
  return (
    <div className="container mx-auto p-10">
      ...
      <div className="flex items-start">
        ...
        <div className='circle-frame ml-16 mt-10'>
          <img 
      ...
      <div className="mt-16 text-center">
        <h2 className="text-7xl text-teal-600 font-serif pt-8 transition-opacity duration-500 ease-in-out opacity-0 animate-fadeIn">My Skills</h2>
